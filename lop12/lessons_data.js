window.ALL_LESSONS_DATA = {
  ...
  "6": [
    {
      "type": "mcq",
      "q": "Cho hình hộp ABCD.A'B'C'D'. Quy tắc hình hộp xác định vectơ đường chéo <math><mover><mi>AC'</mi><mo>→</mo></mover></math> bằng tổng của ba vectơ nào có chung gốc A?",
      "opts": [
        "<math><mover><mi>AC'</mi><mo>→</mo></mover></math> = <math><mover><mi>AB</mi><mo>→</mo></mover></math> + <math><mover><mi>AD</mi><mo>→</mo></mover></math> + <math><mover><mi>AA'</mi><mo>→</mo></mover></math>",
        "<math><mover><mi>AC'</mi><mo>→</mo></mover></math> = <math><mover><mi>AB</mi><mo>→</mo></mover></math> + <math><mover><mi>BC</mi><mo>→</mo></mover></math> + <math><mover><mi>CD</mi><mo>→</mo></mover></math>",
        "<math><mover><mi>AC'</mi><mo>→</mo></mover></math> = <math><mover><mi>A'B'</mi><mo>→</mo></mover></math> + <math><mover><mi>A'D'</mi><mo>→</mo></mover></math> + <math><mover><mi>AA'</mi><mo>→</mo></mover></math>",
        "<math><mover><mi>AC'</mi><mo>→</mo></mover></math> = <math><mover><mi>AB</mi><mo>→</mo></mover></math> - <math><mover><mi>AD</mi><mo>→</mo></mover></math> + <math><mover><mi>AA'</mi><mo>→</mo></mover></math>"
      ],
      "ans": 0,
      "correctText": "Phương án A: <math><mover><mi>AC'</mi><mo>→</mo></mover></math> = <math><mover><mi>AB</mi><mo>→</mo></mover></math> + <math><mover><mi>AD</mi><mo>→</mo></mover></math> + <math><mover><mi>AA'</mi><mo>→</mo></mover></math>",
      "exp": "• <b>Quy tắc hình hộp (SGK Toán 12):</b> Cho hình hộp ABCD.A'B'C'D'. Vectơ đường chéo xuất phát từ đỉnh A bằng tổng ba vectơ cạnh xuất phát từ đỉnh A:<br><math><mover><mi>AC'</mi><mo>→</mo></mover></math> = <math><mover><mi>AB</mi><mo>→</mo></mover></math> + <math><mover><mi>AD</mi><mo>→</mo></mover></math> + <math><mover><mi>AA'</mi><mo>→</mo></mover></math>."
    },
    {
      "type": "mcq",
      "q": "Cho hình lập phương ABCD.A'B'C'D' có cạnh bằng a. Tính tích vô hướng <math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>A'C'</mi><mo>→</mo></mover></math>.",
      "opts": [
        "a²",
        "0",
      ...
      "exp": "• Do A'B'C'D' là hình vuông cạnh a và <math><mover><mi>A'C'</mi><mo>→</mo></mover></math> = <math><mover><mi>AC</mi><mo>→</mo></mover></math> nên:<br><math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>A'C'</mi><mo>→</mo></mover></math> = <math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>AC</mi><mo>→</mo></mover></math> = |<math><mover><mi>AB</mi><mo>→</mo></mover></math>| · |<math><mover><mi>AC</mi><mo>→</mo></mover></math>| · cos(<math><mover><mi>AB</mi><mo>→</mo></mover></math>, <math><mover><mi>AC</mi><mo>→</mo></mover></math>).<br>• |<math><mover><mi>AB</mi><mo>→</mo></mover></math>| = a, |<math><mover><mi>AC</mi><mo>→</mo></mover></math>| = a<span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2</span></span>, góc BAC = 45°.<br>• Tích vô hướng: a · a<span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2</span></span> · cos(45°) = a · a<span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2</span></span> · <span class=\"fraction\"><span class=\"numerator\"><span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2</span></span></span><span class=\"denominator\">2</span></span> = <b>a²</b>."
    },
    {
      "type": "mcq",
      "q": "Cho tứ diện đều ABCD cạnh bằng a. Góc giữa hai vectơ <math><mover><mi>AB</mi><mo>→</mo></mover></math> và <math><mover><mi>CD</mi><mo>→</mo></mover></math> bằng bao nhiêu độ?",
      "opts": [
        "90°",
        "60°",
        "45°",
      ...
      "exp": "• Ta tính tích vô hướng: <math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>CD</mi><mo>→</mo></mover></math> = <math><mover><mi>AB</mi><mo>→</mo></mover></math> · (<math><mover><mi>AD</mi><mo>→</mo></mover></math> - <math><mover><mi>AC</mi><mo>→</mo></mover></math>) = <math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>AD</mi><mo>→</mo></mover></math> - <math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>AC</mi><mo>→</mo></mover></math>.<br>• Vì tứ diện đều các mặt là tam giác đều cạnh a nên góc BAD = BAC = 60°:<br><math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>AD</mi><mo>→</mo></mover></math> = a · a · cos 60° = <span class=\"fraction\"><span class=\"numerator\">a²</span><span class=\"denominator\">2</span></span>.<br><math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>AC</mi><mo>→</mo></mover></math> = a · a · cos 60° = <span class=\"fraction\"><span class=\"numerator\">a²</span><span class=\"denominator\">2</span></span>.<br>• Do đó <math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>CD</mi><mo>→</mo></mover></math> = <span class=\"fraction\"><span class=\"numerator\">a²</span><span class=\"denominator\">2</span></span> - <span class=\"fraction\"><span class=\"numerator\">a²</span><span class=\"denominator\">2</span></span> = 0 ⇒ Hai vectơ vuông góc, góc giữa chúng bằng <b>90°</b>."
    },
    {
      "type": "tf",
      "q": "Cho hình hộp chữ nhật ABCD.A'B'C'D' có các cạnh AB = 3, AD = 4, AA' = 5. Xét tính Đúng/Sai của từng mệnh đề sau:",
      "stmts": [
        "Vectơ tổng <math><mover><mi>u</mi><mo>→</mo></mover></math> = <math><mover><mi>AB</mi><mo>→</mo></mover></math> + <math><mover><mi>AD</mi><mo>→</mo></mover></math> + <math><mover><mi>AA'</mi><mo>→</mo></mover></math> bằng vectơ đường chéo <math><mover><mi>AC'</mi><mo>→</mo></mover></math>.",
        "Độ dài của đường chéo hình hộp chữ nhật là AC' = 5<span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2</span></span>.",
        "Tích vô hướng <math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>AD</mi><mo>→</mo></mover></math> = 0 do AB vuông góc với AD.",
        "Góc giữa hai vectơ <math><mover><mi>AC</mi><mo>→</mo></mover></math> và <math><mover><mi>AA'</mi><mo>→</mo></mover></math> bằng 45°."
      ],
      "ans": [
        true,
        true,
      ...
      "correctText": "a) Đúng • b) Đúng • c) Đúng • d) Sai",
      "exp": "• <b>Ý a [Đúng]:</b> Theo quy tắc hình hộp: <math><mover><mi>AB</mi><mo>→</mo></mover></math> + <math><mover><mi>AD</mi><mo>→</mo></mover></math> + <math><mover><mi>AA'</mi><mo>→</mo></mover></math> = <math><mover><mi>AC'</mi><mo>→</mo></mover></math>.<br>• <b>Ý b [Đúng]:</b> AC' = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">AB² + AD² + AA'²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">3² + 4² + 5²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">9 + 16 + 25</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">50</span></span> = 5<span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2</span></span>.<br>• <b>Ý c [Đúng]:</b> Đáy là hình chữ nhật nên AB ⊥ AD ⇒ <math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>AD</mi><mo>→</mo></mover></math> = 0.<br>• <b>Ý d [Sai]:</b> Đường thẳng AA' vuông góc với mặt phẳng đáy (ABCD) nên AA' ⊥ AC ⇒ góc giữa <math><mover><mi>AC</mi><mo>→</mo></mover></math> và <math><mover><mi>AA'</mi><mo>→</mo></mover></math> bằng 90°, không phải 45°."
    },
    {
      "type": "match",
    ...
    },
    {
      ...
      "text": "Trong không gian, ba vectơ được gọi là [blank] nếu các giá của chúng cùng [blank] với một mặt phẳng. Nếu có hai vectơ không cùng phương thì ba vectơ đồng phẳng khi và chỉ khi có các số m, n sao cho <math><mover><mi>c</mi><mo>→</mo></mover></math> = [blank] + [blank].",
      "words": [
        "đồng phẳng",
        "song song hoặc nằm trong",
        "m<math><mover><mi>a</mi><mo>→</mo></mover></math>",
        "n<math><mover><mi>b</mi><mo>→</mo></mover></math>",
        "cùng phương",
        "vuông góc"
      ],
      "ans": [
      ...
      "correctText": "(1) đồng phẳng • (2) song song hoặc nằm trong • (3) m<math><mover><mi>a</mi><mo>→</mo></mover></math> • (4) n<math><mover><mi>b</mi><mo>→</mo></mover></math>",
      "exp": "• <b>Định lý đồng phẳng (SGK Toán 12):</b> Ba vectơ đồng phẳng khi các giá của chúng cùng song song hoặc nằm trên một mặt phẳng. Điều kiện cần và đủ là một vectơ phân tích tuyến tính được qua hai vectơ kia: <math><mover><mi>c</mi><mo>→</mo></mover></math> = m<math><mover><mi>a</mi><mo>→</mo></mover></math> + n<math><mover><mi>b</mi><mo>→</mo></mover></math>."
    },
    {
      "type": "mcq",
      "q": "Cho hình hộp chữ nhật ABCD.A'B'C'D' có kích thước AB = 2, AD = 3, AA' = 6. Tính độ dài vectơ tổng <math><mover><mi>w</mi><mo>→</mo></mover></math> = <math><mover><mi>AB</mi><mo>→</mo></mover></math> + <math><mover><mi>AD</mi><mo>→</mo></mover></math> + <math><mover><mi>AA'</mi><mo>→</mo></mover></math>.",
      "opts": [
        "7",
        "11",
      ...
      "exp": "• Theo quy tắc hình hộp: <math><mover><mi>w</mi><mo>→</mo></mover></math> = <math><mover><mi>AB</mi><mo>→</mo></mover></math> + <math><mover><mi>AD</mi><mo>→</mo></mover></math> + <math><mover><mi>AA'</mi><mo>→</mo></mover></math> = <math><mover><mi>AC'</mi><mo>→</mo></mover></math>.<br>• Độ dài vectơ: |<math><mover><mi>w</mi><mo>→</mo></mover></math>| = AC' = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">AB² + AD² + AA'²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2² + 3² + 6²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">4 + 9 + 36</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">49</span></span> = <b>7</b>.",
    ...
    {
      "type": "mcq",
      "q": "Cho hình chóp S.ABC có đáy ABC là tam giác đều cạnh a, cạnh bên SA ⊥ (ABC) và SA = a<span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">3</span></span>. Tính côsin góc giữa hai vectơ <math><mover><mi>SB</mi><mo>→</mo></mover></math> và <math><mover><mi>AB</mi><mo>→</mo></mover></math>.",
      "opts": [
        "1/2",
      ...
      "exp": "• Tam giác SAB vuông tại A: SA = a<span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">3</span></span>, AB = a ⇒ SB = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">SA² + AB²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">3a² + a²</span></span> = 2a.<br>• Trong tam giác vuông SAB: cos(SBA) = <span class=\"fraction\"><span class=\"numerator\">AB</span><span class=\"denominator\">SB</span></span> = <span class=\"fraction\"><span class=\"numerator\">a</span><span class=\"denominator\">2a</span></span> = <span class=\"fraction\"><span class=\"numerator\">1</span><span class=\"denominator\">2</span></span> (góc SBA = 60°).<br>• Góc giữa hai vectơ: (<math><mover><mi>SB</mi><mo>→</mo></mover></math>, <math><mover><mi>AB</mi><mo>→</mo></mover></math>) = 180° - SBA? Chú ý: <math><mover><mi>BS</mi><mo>→</mo></mover></math> và <math><mover><mi>BA</mi><mo>→</mo></mover></math> có chung gốc B, góc giữa chúng là góc SBA = 60°.<br>Vectơ <math><mover><mi>SB</mi><mo>→</mo></mover></math> = -<math><mover><mi>BS</mi><mo>→</mo></mover></math> ⇒ cos(<math><mover><mi>SB</mi><mo>→</mo></mover></math>, <math><mover><mi>AB</mi><mo>→</mo></mover></math>) = cos(-<math><mover><mi>BS</mi><mo>→</mo></mover></math>, -<math><mover><mi>BA</mi><mo>→</mo></mover></math>) = cos(<math><mover><mi>BS</mi><mo>→</mo></mover></math>, <math><mover><mi>BA</mi><mo>→</mo></mover></math>) = cos 60° = <b>1/2</b>."
    },
    {
      "type": "tf",
      ...
      "stmts": [
        ...
        "Hệ lực tác dụng lên đèn cân bằng: <span class=\"math-sym\">T</span><sub style=\"font-size:0.8em\">A</sub> + <span class=\"math-sym\">T</span><sub style=\"font-size:0.8em\">B</sub> + <span class=\"math-sym\">T</span><sub style=\"font-size:0.8em\">C</sub> + <span class=\"math-sym\">P</span> = <math><mover><mn>0</mn><mo>→</mo></mover></math>.",
    ...
    },
    {
      ...
      "exp": "• Chọn hệ trục 3 chiều vuông góc: hướng Đông (trục Ox), hướng Bắc (trục Oy), hướng thẳng đứng (trục Oz).<br>• Vectơ vận tốc tổng hợp của máy bay: <math><mover><mi>v</mi><mo>→</mo></mover></math> = (150; 800; 50).<br>• Tốc độ thực tế so với mặt đất: |<math><mover><mi>v</mi><mo>→</mo></mover></math>| = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">150² + 800² + 50²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">22500 + 640000 + 2500</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">665000</span></span> ≈ <b>815,5 km/h</b>."
    }
  ],
  "7": [
    {
      ...
      "opts": [
        "<math><mover><mi>i</mi><mo>→</mo></mover></math> = (1; 0; 0), <math><mover><mi>j</mi><mo>→</mo></mover></math> = (0; 1; 0), <math><mover><mi>k</mi><mo>→</mo></mover></math> = (0; 0; 1)",
        "<math><mover><mi>i</mi><mo>→</mo></mover></math> = (0; 1; 0), <math><mover><mi>j</mi><mo>→</mo></mover></math> = (1; 0; 0), <math><mover><mi>k</mi><mo>→</mo></mover></math> = (0; 0; 1)",
        "<math><mover><mi>i</mi><mo>→</mo></mover></math> = (1; 1; 0), <math><mover><mi>j</mi><mo>→</mo></mover></math> = (0; 1; 1), <math><mover><mi>k</mi><mo>→</mo></mover></math> = (1; 0; 1)",
        "<math><mover><mi>i</mi><mo>→</mo></mover></math> = (1; 0; 0), <math><mover><mi>j</mi><mo>→</mo></mover></math> = (0; 0; 1), <math><mover><mi>k</mi><mo>→</mo></mover></math> = (0; 1; 0)"
      ],
      "ans": 0,
      "correctText": "Phương án A: <math><mover><mi>i</mi><mo>→</mo></mover></math> = (1; 0; 0), <math><mover><mi>j</mi><mo>→</mo></mover></math> = (0; 1; 0), <math><mover><mi>k</mi><mo>→</mo></mover></math> = (0; 0; 1)",
      "exp": "• <b>Định nghĩa hệ toạ độ Oxyz (SGK Toán 12):</b> Hệ trục toạ độ không gian gồm ba trục toạ độ đôi một vuông góc Ox, Oy, Oz với ba vectơ đơn vị tương ứng là <math><mover><mi>i</mi><mo>→</mo></mover></math> = (1; 0; 0), <math><mover><mi>j</mi><mo>→</mo></mover></math> = (0; 1; 0), <math><mover><mi>k</mi><mo>→</mo></mover></math> = (0; 0; 1)."
    },
    {
      "type": "mcq",
    ...
    },
    {
      ...
      "correctText": "a) Đúng • b) Đúng • c) Đúng • d) Đúng",
      "exp": "• <b>Ý a [Đúng]:</b> M(-0,5; 0,5; 2,5).<br>• <b>Ý b [Đúng]:</b> G(1; 1; 2).<br>• <b>Ý c [Đúng]:</b> BC = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">(4 - (-2))² + (2 - 1)² + (1 - 3)²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">36 + 1 + 4</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">41</span></span>.<br>• <b>Ý d [Đúng]:</b> ABCD là hình bình hành ⇔ <math><mover><mi>AD</mi><mo>→</mo></mover></math> = <math><mover><mi>BC</mi><mo>→</mo></mover></math> = (6; 1; -2) ⇒ D(1+6; 0+1; 2-2) = (7; 1; 0)."
    },
    {
      "type": "match",
    ...
    },
    {
      ...
      "text": "Trong không gian Oxyz, toạ độ của điểm M là toạ độ của vectơ [blank]. Nếu <math><mover><mi>OM</mi><mo>→</mo></mover></math> = x<math><mover><mi>i</mi><mo>→</mo></mover></math> + y<math><mover><mi>j</mi><mo>→</mo></mover></math> + z<math><mover><mi>k</mi><mo>→</mo></mover></math> thì ta viết M([blank]). Số x được gọi là [blank], y là [blank], z là [blank] của điểm M.",
      "words": [
        "<math><mover><mi>OM</mi><mo>→</mo></mover></math>",
        "x; y; z",
        "hoành độ",
        "tung độ",
        "cao độ",
        "<math><mover><mi>MO</mi><mo>→</mo></mover></math>"
      ],
      "ans": [
        0,
        1,
      ...
      "correctText": "(1) <math><mover><mi>OM</mi><mo>→</mo></mover></math> • (2) x; y; z • (3) hoành độ • (4) tung độ • (5) cao độ",
      "exp": "• <b>Quy chuẩn toạ độ điểm (SGK Toán 12):</b> Toạ độ điểm M chính là bộ ba số (x; y; z) tương ứng với khai triển vectơ vị trí <math><mover><mi>OM</mi><mo>→</mo></mover></math> theo bộ ba vectơ đơn vị."
    },
    {
      "type": "mcq",
    ...
    },
    {
      ...
      "stmts": [
        ...
        "Vectơ độ dời của máy bay trong 5 phút là <math><mover><mi>AB</mi><mo>→</mo></mover></math> = (30; 40; 2).",
      ...
      "correctText": "a) Đúng • b) Đúng • c) Đúng • d) Đúng",
      "exp": "• <b>Ý a [Đúng]:</b> OA = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">30² + 40² + 8²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">900 + 1600 + 64</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2564</span></span> ≈ 50,64 km.<br>• <b>Ý b [Đúng]:</b> <math><mover><mi>AB</mi><mo>→</mo></mover></math> = (60 - 30; 80 - 40; 10 - 8) = (30; 40; 2).<br>• <b>Ý c [Đúng]:</b> Quãng đường AB = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">30² + 40² + 2²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2500 + 4</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2504</span></span> ≈ 50,04 km.<br>• <b>Ý d [Đúng]:</b> Thời gian 5 phút = 5/60 giờ = 1/12 giờ. Vận tốc v = s/t = 50,04 / (1/12) ≈ 600,5 km/h."
    },
    {
      "type": "mcq",
  ...
  "8": [
    {
      "type": "mcq",
      "q": "Trong không gian Oxyz, cho hai vectơ <math><mover><mi>u</mi><mo>→</mo></mover></math> = (x₁; y₁; z₁) và <math><mover><mi>v</mi><mo>→</mo></mover></math> = (x₂; y₂; z₂). Biểu thức toạ độ của tích vô hướng <math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> là:",
      "opts": [
        "<math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> = x₁x₂ + y₁y₂ + z₁z₂",
        "<math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> = (x₁ + x₂; y₁ + y₂; z₁ + z₂)",
        "<math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> = x₁y₂ - x₂y₁",
        "<math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">x₁x₂ + y₁y₂ + z₁z₂</span></span>"
      ],
      "ans": 0,
      "correctText": "Phương án A: <math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> = x₁x₂ + y₁y₂ + z₁z₂",
      "exp": "• <b>Công thức tích vô hướng (SGK Toán 12):</b> Tích vô hướng của hai vectơ bằng tổng các tích của các toạ độ tương ứng:<br><math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> = x₁x₂ + y₁y₂ + z₁z₂."
    },
    {
      "type": "mcq",
      "q": "Cho hai vectơ <math><mover><mi>a</mi><mo>→</mo></mover></math> = (1; -2; 3) và <math><mover><mi>b</mi><mo>→</mo></mover></math> = (2; 1; -1). Tính tích vô hướng <math><mover><mi>a</mi><mo>→</mo></mover></math> · <math><mover><mi>b</mi><mo>→</mo></mover></math>.",
      "opts": [
        "-3",
        "3",
        "-1",
      ...
      "exp": "• Thay toạ độ vào biểu thức tích vô hướng:<br><math><mover><mi>a</mi><mo>→</mo></mover></math> · <math><mover><mi>b</mi><mo>→</mo></mover></math> = 1·2 + (-2)·1 + 3·(-1) = 2 - 2 - 3 = <b>-3</b>."
    },
    {
      "type": "mcq",
      "q": "Tính côsin của góc giữa hai vectơ <math><mover><mi>u</mi><mo>→</mo></mover></math> = (2; 1; 0) và <math><mover><mi>v</mi><mo>→</mo></mover></math> = (-1; 2; <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">5</span></span>).",
      "opts": [
      ...
      "exp": "• Tính tích vô hướng: <math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> = 2·(-1) + 1·2 + 0·<span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">5</span></span> = -2 + 2 + 0 = 0.<br>• Do tích vô hướng bằng 0 nên cos(<math><mover><mi>u</mi><mo>→</mo></mover></math>, <math><mover><mi>v</mi><mo>→</mo></mover></math>) = 0 (tức góc giữa hai vectơ bằng 90°)."
    },
    {
      "type": "tf",
      "q": "Trong không gian Oxyz, cho ba điểm A(1; 0; 0), B(0; 2; 0), C(0; 0; 3). Xét tính Đúng/Sai của từng nhận định sau:",
      "stmts": [
        "Toạ độ hai vectơ là <math><mover><mi>AB</mi><mo>→</mo></mover></math> = (-1; 2; 0) và <math><mover><mi>AC</mi><mo>→</mo></mover></math> = (-1; 0; 3).",
        "Tích vô hướng <math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>AC</mi><mo>→</mo></mover></math> = 1.",
      ...
      "correctText": "a) Đúng • b) Đúng • c) Đúng • d) Đúng",
      "exp": "• <b>Ý a [Đúng]:</b> <math><mover><mi>AB</mi><mo>→</mo></mover></math> = (-1; 2; 0), <math><mover><mi>AC</mi><mo>→</mo></mover></math> = (-1; 0; 3).<br>• <b>Ý b [Đúng]:</b> <math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>AC</mi><mo>→</mo></mover></math> = (-1)(-1) + 2·0 + 0·3 = 1.<br>• <b>Ý c [Đúng]:</b> AB = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">(-1)² + 2²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">5</span></span>, AC = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">(-1)² + 3²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">10</span></span>.<br>• <b>Ý d [Đúng]:</b> cos BAC = <span class=\"fraction\"><span class=\"numerator\"><math><mover><mi>AB</mi><mo>→</mo></mover></math> · <math><mover><mi>AC</mi><mo>→</mo></mover></math></span><span class=\"denominator\">AB · AC</span></span> = <span class=\"fraction\"><span class=\"numerator\">1</span><span class=\"denominator\"><span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">5</span></span> · <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">10</span></span></span></span> = <span class=\"fraction\"><span class=\"numerator\">1</span><span class=\"denominator\">5<span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2</span></span></span></span>."
    },
    {
      "type": "match",
      "q": "Ghép các biểu thức vectơ toạ độ (Cột A) với các đại lượng thực tế/kĩ thuật tương ứng (Cột B):",
      "colA": [
        "Công cơ học của lực: A = <span class=\"math-sym\">F</span> · <math><mover><mi>d</mi><mo>→</mo></mover></math>",
        "Độ lớn vận tốc tổng hợp: v = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">v_x² + v_y² + v_z²</span></span>",
        "Điều kiện cân bằng tĩnh học: <span class=\"math-sym\">F</span>₁ + <span class=\"math-sym\">F</span>₂ + <span class=\"math-sym\">F</span>₃ = <math><mover><mn>0</mn><mo>→</mo></mover></math>",
        "Góc chiếu tia sáng mặt trời: cos θ = <span class=\"fraction\"><span class=\"numerator\">|<span class=\"math-sym\">s</span> · <math><mover><mi>n</mi><mo>→</mo></mover></math>|</span><span class=\"denominator\">|<span class=\"math-sym\">s</span>||<math><mover><mi>n</mi><mo>→</mo></mover></math>|</span></span>"
      ],
      "colB": [
    ...
    },
    {
      ...
      "text": "Hai vectơ <math><mover><mi>u</mi><mo>→</mo></mover></math> và <math><mover><mi>v</mi><mo>→</mo></mover></math> vuông góc với nhau khi và chỉ khi [blank]. Hai vectơ cùng phương khi và chỉ khi tồn tại số k sao cho [blank] (hoặc các tỉ số toạ độ tương ứng bằng nhau [blank] nếu các toạ độ mẫu khác 0).",
      "words": [
        "<math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> = 0",
        "<math><mover><mi>u</mi><mo>→</mo></mover></math> = k<math><mover><mi>v</mi><mo>→</mo></mover></math>",
        ...
        "<math><mover><mi>u</mi><mo>→</mo></mover></math> + <math><mover><mi>v</mi><mo>→</mo></mover></math> = <math><mover><mn>0</mn><mo>→</mo></mover></math>",
        "|<math><mover><mi>u</mi><mo>→</mo></mover></math>| = |<math><mover><mi>v</mi><mo>→</mo></mover></math>|"
      ],
      "ans": [
        0,
        1,
    ...
    {
      "type": "mcq",
      "q": "Tìm tham số m để hai vectơ <math><mover><mi>u</mi><mo>→</mo></mover></math> = (m; 1; -2) và <math><mover><mi>v</mi><mo>→</mo></mover></math> = (2; -4; 1) vuông góc với nhau.",
      "opts": [
        "m = 3",
        "m = -3",
        "m = 2",
      ...
      "exp": "• Điều kiện để hai vectơ vuông góc: <math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> = 0.<br>• 2·m + 1·(-4) + (-2)·1 = 0 ⇔ 2m - 4 - 2 = 0 ⇔ 2m = 6 ⇔ <b>m = 3</b>."
    },
    {
      "type": "tf",
    ...
    },
    {
      ...
      "exp": "• Vectơ độ dời: <math><mover><mi>d</mi><mo>→</mo></mover></math> = <math><mover><mi>AB</mi><mo>→</mo></mover></math> = (4 - 1; 6 - 2; 0 - 0) = (3; 4; 0) (m).<br>• Công sinh ra: A = <span class=\"math-sym\">F</span> · <math><mover><mi>d</mi><mo>→</mo></mover></math> = 20·3 + 30·4 + 5·0 = 60 + 120 + 0 = <b>180 Jun</b>."
    }
  ],
  "9": [
    {
  ...
  "14": [
    {
      ...
      "exp": "• <b>Phương trình tổng quát của mặt phẳng (SGK Toán 12):</b> Mọi mặt phẳng trong không gian Oxyz đều có phương trình dạng Ax + By + Cz + D = 0, trong đó vectơ <math><mover><mi>n</mi><mo>→</mo></mover></math> = (A; B; C) là vectơ pháp tuyến (A, B, C không đồng thời bằng 0)."
    },
    {
      "type": "mcq",
      "q": "Viết phương trình mặt phẳng đi qua điểm M(1; -2; 3) và nhận vectơ <math><mover><mi>n</mi><mo>→</mo></mover></math> = (2; -1; 4) làm vectơ pháp tuyến.",
      "opts": [
        "2x - y + 4z - 16 = 0",
        "2x - y + 4z + 16 = 0",
        "x - 2y + 3z - 16 = 0",
    ...
    },
    {
      ...
      "stmts": [
        ...
        "Vectơ <math><mover><mi>n</mi><mo>→</mo></mover></math> = (6; -4; 3) là một vectơ pháp tuyến của mặt phẳng (ABC).",
      ...
      "correctText": "a) Đúng • b) Đúng • c) Đúng • d) Đúng",
      "exp": "• <b>Ý a [Đúng]:</b> Ba điểm trên 3 trục: x/a + y/b + z/c = 1 ⇔ x/2 + y/(-3) + z/4 = 1.<br>• <b>Ý b [Đúng]:</b> Quy đồng mẫu số chung là 12: 6x - 4y + 3z = 12 ⇔ 6x - 4y + 3z - 12 = 0.<br>• <b>Ý c [Đúng]:</b> Hệ số trước x, y, z cho VTPT <math><mover><mi>n</mi><mo>→</mo></mover></math> = (6; -4; 3).<br>• <b>Ý d [Đúng]:</b> d(O, (ABC)) = |-12| / <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">6² + (-4)² + 3²</span></span> = 12 / <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">36 + 16 + 9</span></span> = 12 / <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">61</span></span>."
    },
    {
      "type": "match",
    ...
    },
    {
      ...
      "text": "Cho hai mặt phẳng (P) và (Q) có VTPT lần lượt là <math><mover><mi>n</mi><mo>→</mo></mover></math>₁ và <math><mover><mi>n</mi><mo>→</mo></mover></math>₂. Hai mặt phẳng vuông góc với nhau khi và chỉ khi [blank]. Hai mặt phẳng song song hoặc trùng nhau khi và chỉ khi hai vectơ pháp tuyến [blank].",
      "words": [
        "<math><mover><mi>n</mi><mo>→</mo></mover></math>₁ · <math><mover><mi>n</mi><mo>→</mo></mover></math>₂ = 0",
        "cùng phương",
        "<math><mover><mi>n</mi><mo>→</mo></mover></math>₁ = <math><mover><mi>n</mi><mo>→</mo></mover></math>₂",
        "cắt nhau"
      ],
      "ans": [
        0,
      ...
      "correctText": "(1) <math><mover><mi>n</mi><mo>→</mo></mover></math>₁ · <math><mover><mi>n</mi><mo>→</mo></mover></math>₂ = 0 • (2) cùng phương",
      "exp": "• (P) ⊥ (Q) ⇔ <math><mover><mi>n</mi><mo>→</mo></mover></math>₁ ⊥ <math><mover><mi>n</mi><mo>→</mo></mover></math>₂ ⇔ <math><mover><mi>n</mi><mo>→</mo></mover></math>₁ · <math><mover><mi>n</mi><mo>→</mo></mover></math>₂ = 0.<br>• (P) // (Q) hoặc (P) ≡ (Q) ⇔ <math><mover><mi>n</mi><mo>→</mo></mover></math>₁ và <math><mover><mi>n</mi><mo>→</mo></mover></math>₂ cùng phương."
    },
    {
      "type": "mcq",
      ...
      "exp": "• Đường thẳng d qua A vuông góc (P) có VTCP <math><mover><mi>u</mi><mo>→</mo></mover></math> = <math><mover><mi>n</mi><mo>→</mo></mover></math><sub style=\"font-size:0.8em\">P</sub> = (1; 1; 1):<br>x = 1 + t, y = 2 + t, z = 3 + t.<br>• Thay vào phương trình (P): (1 + t) + (2 + t) + (3 + t) - 3 = 0 ⇔ 3t + 3 = 0 ⇔ t = -1.<br>• Với t = -1 ⇒ x = 0, y = 1, z = 2. Vậy toạ độ hình chiếu là <b>H(0; 1; 2)</b>.",
    ...
    },
    {
      ...
      "stmts": [
        "Hai vectơ chỉ phương trên mặt kính là <math><mover><mi>AB</mi><mo>→</mo></mover></math> = (-4; 6; -1) và <math><mover><mi>AC</mi><mo>→</mo></mover></math> = (-2; 3; 1).",
        "Tích có hướng của hai vectơ là [<math><mover><mi>AB</mi><mo>→</mo></mover></math>, <math><mover><mi>AC</mi><mo>→</mo></mover></math>] = (9; 6; 0).",
      ...
      "correctText": "a) Đúng • b) Đúng • c) Đúng • d) Đúng",
      "exp": "• <b>Ý a [Đúng]:</b> <math><mover><mi>AB</mi><mo>→</mo></mover></math> = (-4; 6; -1), <math><mover><mi>AC</mi><mo>→</mo></mover></math> = (-2; 3; 1).<br>• <b>Ý b [Đúng]:</b> [<math><mover><mi>AB</mi><mo>→</mo></mover></math>, <math><mover><mi>AC</mi><mo>→</mo></mover></math>] = (6·1 - (-1)·3; (-1)(-2) - (-4)·1; (-4)·3 - 6(-2)) = (9; 6; 0).<br>• <b>Ý c [Đúng]:</b> VTPT chọn <math><mover><mi>n</mi><mo>→</mo></mover></math> = (3; 2; 0). Qua A(4; 0; 2): 3(x - 4) + 2(y - 0) + 0(z - 2) = 0 ⇔ 3x + 2y - 12 = 0.<br>• <b>Ý d [Đúng]:</b> VTPT <math><mover><mi>n</mi><mo>→</mo></mover></math> = (3; 2; 0) vuông góc với vectơ <math><mover><mi>k</mi><mo>→</mo></mover></math> = (0; 0; 1) của trục Oz ⇒ Mặt kính vuông góc mặt sàn."
    },
    {
      "type": "mcq",
  ...
  "15": [
    {
      "type": "mcq",
      "q": "Đường thẳng d đi qua điểm M₀(x₀; y₀; z₀) và có vectơ chỉ phương <math><mover><mi>u</mi><mo>→</mo></mover></math> = (a; b; c) (với a, b, c đều khác 0) có phương trình chính tắc là:",
      "opts": [
    ...
    {
      "type": "mcq",
      "q": "Viết phương trình tham số của đường thẳng d đi qua điểm A(1; 2; -3) và có vectơ chỉ phương <math><mover><mi>u</mi><mo>→</mo></mover></math> = (2; -1; 5).",
      "opts": [
    ...
    },
    {
      ...
      "stmts": [
        "Vectơ chỉ phương của đường thẳng AB có thể chọn là <math><mover><mi>u</mi><mo>→</mo></mover></math> = (1; 1; 1).",
      ...
      "correctText": "a) Đúng • b) Đúng • c) Đúng • d) Đúng",
      "exp": "• <b>Ý a [Đúng]:</b> <math><mover><mi>AB</mi><mo>→</mo></mover></math> = (2; 2; 2) = 2(1; 1; 1) ⇒ chọn <math><mover><mi>u</mi><mo>→</mo></mover></math> = (1; 1; 1).<br>• <b>Ý b [Đúng]:</b> Qua A(1; -1; 2) với VTCP (1; 1; 1): (x - 1)/1 = (y + 1)/1 = (z - 2)/1.<br>• <b>Ý c [Đúng]:</b> Thay M(5; 3; 6): (5-1)/1 = (3+1)/1 = (6-2)/1 = 4 (thỏa mãn).<br>• <b>Ý d [Đúng]:</b> VTPT của (α) là <math><mover><mi>n</mi><mo>→</mo></mover></math> = (1; 1; 1) cùng phương với VTCP của đường thẳng ⇒ AB ⊥ (α)."
    },
    {
      "type": "match",
      ...
      "colA": [
        ...
        "Tia laser định vị chiếu từ đỉnh tháp (0; 0; 100) theo hướng <math><mover><mi>u</mi><mo>→</mo></mover></math> = (3; 4; -1)",
    ...
    },
    {
      ...
      "text": "Nếu hai vectơ chỉ phương <math><mover><mi>u</mi><mo>→</mo></mover></math>₁ và <math><mover><mi>u</mi><mo>→</mo></mover></math>₂ cùng phương thì d₁ và d₂ [blank] hoặc [blank]. Nếu <math><mover><mi>u</mi><mo>→</mo></mover></math>₁ và <math><mover><mi>u</mi><mo>→</mo></mover></math>₂ không cùng phương và hệ phương trình toạ độ vô nghiệm thì d₁ và d₂ [blank].",
      "words": [
        "song song",
        "trùng nhau",
        "chéo nhau",
    ...
    },
    {
      ...
      "exp": "• VTCP: <math><mover><mi>u</mi><mo>→</mo></mover></math>₁ = (1; 1; 1) và <math><mover><mi>u</mi><mo>→</mo></mover></math>₂ = (1; 2; 3) không cùng phương (1/1 ≠ 1/2).<br>• Xét hệ giao điểm: t = 1 + s; t = 2s; t = 3s.<br>Từ 2s = 3s ⇒ s = 0 ⇒ t = 0. Thay vào pt 1: 0 = 1 + 0 (vô lý).<br>• Hệ vô nghiệm và 2 VTCP không cùng phương ⇒ Hai đường thẳng <b>chéo nhau</b>.",
    ...
    },
    {
      ...
      "stmts": [
        "Vectơ chỉ phương của đường bay có thể chọn là <math><mover><mi>u</mi><mo>→</mo></mover></math> = (3; 4; 1).",
  ...
  "16": [
    {
      "type": "mcq",
      "q": "Cho hai đường thẳng d₁ và d₂ có vectơ chỉ phương lần lượt là <math><mover><mi>u</mi><mo>→</mo></mover></math>₁ và <math><mover><mi>u</mi><mo>→</mo></mover></math>₂. Góc φ giữa hai đường thẳng d₁ và d₂ được tính bởi công thức nào?",
      "opts": [
        "cos φ = <span class=\"fraction\"><span class=\"numerator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁ · <math><mover><mi>u</mi><mo>→</mo></mover></math>₂|</span><span class=\"denominator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁| · |<math><mover><mi>u</mi><mo>→</mo></mover></math>₂|</span></span> (với 0° ≤ φ ≤ 90°)",
        "cos φ = <span class=\"fraction\"><span class=\"numerator\"><math><mover><mi>u</mi><mo>→</mo></mover></math>₁ · <math><mover><mi>u</mi><mo>→</mo></mover></math>₂</span><span class=\"denominator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁| · |<math><mover><mi>u</mi><mo>→</mo></mover></math>₂|</span></span>",
        "sin φ = <span class=\"fraction\"><span class=\"numerator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁ · <math><mover><mi>u</mi><mo>→</mo></mover></math>₂|</span><span class=\"denominator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁| · |<math><mover><mi>u</mi><mo>→</mo></mover></math>₂|</span></span>",
        "tan φ = <span class=\"fraction\"><span class=\"numerator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁ · <math><mover><mi>u</mi><mo>→</mo></mover></math>₂|</span><span class=\"denominator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁| · |<math><mover><mi>u</mi><mo>→</mo></mover></math>₂|</span></span>"
      ],
      "ans": 0,
      "correctText": "Phương án A: cos φ = <span class=\"fraction\"><span class=\"numerator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁ · <math><mover><mi>u</mi><mo>→</mo></mover></math>₂|</span><span class=\"denominator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁| · |<math><mover><mi>u</mi><mo>→</mo></mover></math>₂|</span></span> (với 0° ≤ φ ≤ 90°)",
      "exp": "• <b>Công thức góc giữa 2 đường thẳng (SGK Toán 12):</b> Góc giữa hai đường thẳng là góc không tù (0° ≤ φ ≤ 90°), do đó tử số phải có dấu giá trị tuyệt đối: cos φ = |<math><mover><mi>u</mi><mo>→</mo></mover></math>₁ · <math><mover><mi>u</mi><mo>→</mo></mover></math>₂| / (|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁| |<math><mover><mi>u</mi><mo>→</mo></mover></math>₂|)."
    },
    {
      "type": "mcq",
    ...
    },
    {
      ...
      "stmts": [
        "Vectơ chỉ phương của đường chéo A'C là <math><mover><mi>u</mi><mo>→</mo></mover></math> = (a; a; -a).",
        "Vectơ chỉ phương của đường thẳng BD là <math><mover><mi>v</mi><mo>→</mo></mover></math> = (-a; a; 0).",
        "Tích vô hướng <math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> = a(-a) + a·a + (-a)·0 = 0.",
      ...
      "correctText": "a) Đúng • b) Đúng • c) Đúng • d) Đúng",
      "exp": "• <b>Ý a [Đúng]:</b> A'(0; 0; a), C(a; a; 0) ⇒ <span class=\"math-sym\">A'C</span> = (a; a; -a).<br>• <b>Ý b [Đúng]:</b> B(a; 0; 0), D(0; a; 0) ⇒ <math><mover><mi>BD</mi><mo>→</mo></mover></math> = (-a; a; 0).<br>• <b>Ý c [Đúng]:</b> <math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>v</mi><mo>→</mo></mover></math> = -a² + a² + 0 = 0.<br>• <b>Ý d [Đúng]:</b> Tích vô hướng bằng 0 nên hai đường thẳng vuông góc nhau (góc 90°)."
    },
    {
      "type": "match",
    ...
    },
    {
      ...
      "text": "Góc giữa hai đường thẳng d₁ và d₂ được xác định qua [blank] φ = <span class=\"fraction\"><span class=\"numerator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁ · <math><mover><mi>u</mi><mo>→</mo></mover></math>₂|</span><span class=\"denominator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>₁||<math><mover><mi>u</mi><mo>→</mo></mover></math>₂|</span></span>. Góc giữa hai mặt phẳng (P) và (Q) được xác định qua [blank] θ = <span class=\"fraction\"><span class=\"numerator\">|<math><mover><mi>n</mi><mo>→</mo></mover></math>₁ · <math><mover><mi>n</mi><mo>→</mo></mover></math>₂|</span><span class=\"denominator\">|<math><mover><mi>n</mi><mo>→</mo></mover></math>₁||<math><mover><mi>n</mi><mo>→</mo></mover></math>₂|</span></span>. Góc giữa đường thẳng d và mặt phẳng (P) được xác định qua [blank] α = <span class=\"fraction\"><span class=\"numerator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math> · <math><mover><mi>n</mi><mo>→</mo></mover></math>|</span><span class=\"denominator\">|<math><mover><mi>u</mi><mo>→</mo></mover></math>||<math><mover><mi>n</mi><mo>→</mo></mover></math>|</span></span>.",
      "words": [
        "cos",
        "sin",
        "tan",
    ...
    },
    {
      ...
      "exp": "• <math><mover><mi>n</mi><mo>→</mo></mover></math>₁ = (1; 1; 0), <math><mover><mi>n</mi><mo>→</mo></mover></math>₂ = (0; 1; 1).<br>• cos φ = |1·0 + 1·1 + 0·1| / (<span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2</span></span> · <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">2</span></span>) = 1/2 ⇒ <b>φ = 60°</b>."
    },
    {
      "type": "tf",
      ...
      "stmts": [
        "Vectơ pháp tuyến của hai mặt phẳng mái ngói là <math><mover><mi>n</mi><mo>→</mo></mover></math>₁ = (3; 0; 4) và <math><mover><mi>n</mi><mo>→</mo></mover></math>₂ = (-3; 0; 4).",
        "Độ lớn của mỗi vectơ pháp tuyến là |<math><mover><mi>n</mi><mo>→</mo></mover></math>₁| = |<math><mover><mi>n</mi><mo>→</mo></mover></math>₂| = 5.",
      ...
      "correctText": "a) Đúng • b) Đúng • c) Đúng • d) Sai",
      "exp": "• <b>Ý a [Đúng]:</b> <math><mover><mi>n</mi><mo>→</mo></mover></math>₁ = (3; 0; 4), <math><mover><mi>n</mi><mo>→</mo></mover></math>₂ = (-3; 0; 4).<br>• <b>Ý b [Đúng]:</b> <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">3² + 0² + 4²</span></span> = <span class=\"sqrt\"><span class=\"rad\">√</span><span class=\"radicand\">25</span></span> = 5.<br>• <b>Ý c [Đúng]:</b> cos θ = |3(-3) + 0 + 4(4)| / (5 · 5) = |-9 + 16| / 25 = 7/25 = 0,28.<br>• <b>Ý d [Sai]:</b> arccos(0,28) ≈ 73,74° (< 80°)."
    },
    {
      "type": "mcq",
