...
<body>
      ...
      <div class="header-bar">
        ...
        <div class="header-group">
          ...
          <select class="lesson-select" id="lessonDropdown" onchange="changeLesson(this.value)">
            <optgroup label="CHƯƠNG I: ỨNG DỤNG ĐẠO HÀM ĐỂ KHẢO SÁT VÀ VẼ ĐỒ THỊ">
              <option value="1">Bài 1: Tính Đơn Điệu & Cực Trị Của Hàm Số</option>
              <option value="2">Bài 2: Giá Trị Lớn Nhất & Nhỏ Nhất Của Hàm Số</option>
              <option value="3">Bài 3: Đường Tiệm Cận Của Đồ Thị Hàm Số</option>
              <option value="4">Bài 4: Khảo Sát Biến Thiên & Vẽ Đồ Thị</option>
              <option value="5">Bài 5: Ứng Dụng Đạo Hàm Bài Toán Thực Tiễn</option>
            </optgroup>
            <optgroup label="CHƯƠNG II: VECTƠ & HỆ TOẠ ĐỘ KHÔNG GIAN">
              <option value="6">Bài 6: Vectơ Trong Không Gian</option>
              <option value="7">Bài 7: Hệ Trục Toạ Độ Trong Không Gian</option>
              <option value="8">Bài 8: Biểu Thức Toạ Độ Phép Toán Vectơ</option>
            </optgroup>
            <optgroup label="CHƯƠNG III: MỨC ĐỘ PHÂN TÁN MẪU GHÉP NHÓM">
              <option value="9">Bài 9: Khoảng Biến Thiên & Khoảng Tứ Phân Vị</option>
              <option value="10">Bài 10: Phương Sai & Độ Lệch Chuẩn</option>
            </optgroup>
            <optgroup label="CHƯƠNG IV: NGUYÊN HÀM VÀ TÍCH PHÂN">
              <option value="11">Bài 11: Nguyên Hàm</option>
              <option value="12">Bài 12: Tích Phân</option>
              <option value="13">Bài 13: Ứng Dụng Hình Học Của Tích Phân</option>
            </optgroup>
            <optgroup label="CHƯƠNG V: PHƯƠNG PHÁP TOẠ ĐỘ KHÔNG GIAN">
              <option value="14">Bài 14: Phương Trình Mặt Phẳng</option>
              <option value="15">Bài 15: Phương Trình Đường Thẳng</option>
              <option value="16">Bài 16: Công Thức Tính Góc Trong Không Gian</option>
              <option value="17">Bài 17: Phương Trình Mặt Cầu</option>
            </optgroup>
            <optgroup label="CHƯƠNG VI: XÁC SUẤT CÓ ĐIỀU KIỆN">
              <option value="18">Bài 18: Xác Suất Có Điều Kiện</option>
              <option value="19">Bài 19: Xác Suất Toàn Phần & Công Thức Bayes</option>
            </optgroup>
          </select>
  ...
  <div class="dashboard-modal" id="dashboardModal" style="display:none;" onclick="if(event.target===this) toggleDashboard()">
    <div class="dashboard-content" onclick="event.stopPropagation()">
      <div class="dashboard-header">
        <h2>📊 HỌC BẠ TIẾN ĐỘ TOÁN HỌC 12 - 6 CHƯƠNG</h2>
  ...
  <script>
    ...
    function goToNextLesson() {
      if (currentLessonId < 19) {
        changeLesson(currentLessonId + 1);
      } else {
        alert('Chúc mừng em đã hoàn thành tất cả 19 bài học của toàn bộ 6 Chương Toán Học 12!');
      }
    }
    ...
    function showResults() {
      ...
      try {
        const key = 'TOAN12_LESSON_SCORE_' + currentLessonId;
      ...
      if (totalPoints >= 9.0) {
        ...
        cmt.textContent = teacherName + ' biểu dương em! Em đã làm chủ hoàn hảo bài học Toán Học 12 với tư duy giải toán sắc bén và năng lực suy luận toán học vượt trội!';
    ...
    function renderDashboard() {
      const chapters = [
        { name: 'CHƯƠNG I: ỨNG DỤNG ĐẠO HÀM KHẢO SÁT HÀM SỐ', start: 1, end: 5 },
        { name: 'CHƯƠNG II: VECTƠ & HỆ TRỤC TOẠ ĐỘ KHÔNG GIAN', start: 6, end: 8 },
        { name: 'CHƯƠNG III: MỨC ĐỘ PHÂN TÁN MẪU GHÉP NHÓM', start: 9, end: 10 },
        { name: 'CHƯƠNG IV: NGUYÊN HÀM & TÍCH PHÂN', start: 11, end: 13 },
        { name: 'CHƯƠNG V: PHƯƠNG PHÁP TOẠ ĐỘ KHÔNG GIAN', start: 14, end: 17 },
        { name: 'CHƯƠNG VI: XÁC SUẤT CÓ ĐIỀU KIỆN', start: 18, end: 19 }
      ];
      ...
      chapters.forEach(ch => {
        ...
        for (let id = ch.start; id <= ch.end; id++) {
          ...
          const scoreStr = SafeStorage.getItem('TOAN12_LESSON_SCORE_' + id);
      ...
      document.getElementById('dashCompletedCount').textContent = completedCount + ' / 19';
    ...
    function resetProgress() {
      if (confirm('Em có chắc chắn muốn xóa tất cả lịch sử điểm số của 19 bài học để làm lại từ đầu không?')) {
        for (let i = 1; i <= 19; i++) {
          SafeStorage.removeItem('TOAN12_LESSON_SCORE_' + i);
        }
        renderDashboard();
...
`;
  fs.writeFileSync('He_Thong_Trac_Nghiem_Toan_12.html', html, 'utf8');
...
<body>
  ...
  <div class="container">
    <header>
      <div class="header-bar">
        ...
        <div class="header-group">
          ...
          <div class="lesson-title-badge">TOÁN HỌC 12 - ${lessonTitle}</div>
        </div>
    ...
    <div class="result-card" id="resultCard">
      ...
      <div style="display: flex; justify-content: center; gap: 10px; flex-wrap: wrap;">
        <button class="btn-action" onclick="restartLesson()">Làm lại bài này ⟲</button>
        <a href="./He_Thong_Trac_Nghiem_Toan_12.html" class="btn-action btn-next-step" style="text-decoration:none;">Về Cổng Tổng Hợp ➔</a>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function showResults() {
      ...
      try {
        const key = 'TOAN12_LESSON_SCORE_' + LESSON_ID;
        const oldScore = parseFloat(SafeStorage.getItem(key) || '0');
        if (totalPoints > oldScore) {
          SafeStorage.setItem(key, totalPoints.toFixed(2));
        }
